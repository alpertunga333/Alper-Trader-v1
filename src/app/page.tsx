                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={candleData} margin={{ top: 5, right: 5, left: -25, bottom: 5 }}>
                      ...
                      <YAxis
                        yAxisId="left"
                        orientation="left"
                        tickFormatter={(value) => value.toLocaleString('en-US', { notation: 'compact', maximumFractionDigits: 1 })} // Simple compact format for ticks
                        tick={{ fontSize: 10, fill: 'hsl(var(--muted-foreground))' }}
                        axisLine={false}
                        tickLine={false}
                      ...
                      <YAxis
                        yAxisId="right"
                        orientation="right"
                         tickFormatter={(value) => value.toLocaleString('en-US', { notation: 'compact' })} // Simple compact format for volume ticks
                        tick={{ fontSize: 10, fill: 'hsl(var(--muted-foreground))' }}
                        axisLine={false}
                        tickLine={false}
